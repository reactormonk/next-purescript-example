...
var mkProfile = (function () {
    var render = React_Basic.fragment([ React_Basic_DOM_Generated.div()({
        ...
        children: [ React_Basic_DOM_Generated.div()({
            ...
            style: React_Basic_DOM_Internal.css({
                backgroundImage: "url('https://source.unsplash.com/lylCw4zcA7I')"
            })
            ...
            }), React_Basic_DOM.text("Rain forest") ]
        }), React_Basic_DOM_Generated.p()({
            className: "pt-4 text-sm",
            children: [ React_Basic_DOM.text("Macaws are beautiful, brilliantly colored members of the parrot family.") ]
        }), React_Basic_DOM_Generated.p()({
            className: "pt-2 text-sm",
            children: [ React_Basic_DOM.text("Many macaws have vibrant plumage. The coloring is suited to life in Central and South American rain forests, with their green canopies and colorful fruits and flowers. The birds boast large, powerful beaks that easily crack nuts and seeds, while their dry, scaly tongues have a bone inside them that makes them an effective tool for tapping into fruits.") ]
        }), React_Basic_DOM_Generated.div()({
            ...
            children: [ React_Basic_DOM_Generated.a()({
                ...
                children: [ React_Basic_DOM_SVG.svg()({
                    ...
                    viewBox: "0 0 24 24",
                    xmlns: "http://www.w3.org/2000/svg",
                    children: [ React_Basic_DOM_SVG.title()({
                        children: [ React_Basic_DOM.text("GitHub") ]
                ...
                children: [ React_Basic_DOM_SVG.svg()({
                    ...
                    xmlns: "http://www.w3.org/2000/svg",
                    children: [ React_Basic_DOM_SVG.title()({
                        children: [ React_Basic_DOM.text("Twitter") ]
                    }), React_Basic_DOM_SVG.path()({
                ...
                children: [ React_Basic_DOM_SVG.svg()({
                    ...
                    xmlns: "http://www.w3.org/2000/svg",
                    children: [ React_Basic_DOM_SVG.title()({
                        children: [ React_Basic_DOM.text("LinkedIn") ]
                    }), React_Basic_DOM_SVG.path()({
    ...
    return Components_Page.component("Profile")(function (v) {
        return function (v1) {
